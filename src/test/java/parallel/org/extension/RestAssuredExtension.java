...
public class RestAssuredExtension {
    ...
    public RestAssuredExtension() {
        logger.info("Setting up the rest assured extension.");
    ...
    public void setUriAndPath(String uri, String path) {
        logger.info("Setting the " + uri + " as base URI and the " + path + " as base path.");
    ...
    public Response getOps(String url) {
        logger.info("Sending a GET request to the " + url + " url.");
    ...
    public void setFollowRedirect(boolean isFollowRedirect) {
        logger.info("Setting follow redirect to " +isFollowRedirect);
